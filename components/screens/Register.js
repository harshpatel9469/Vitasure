    ...
    return (
        <Wrapper>
            ...
            <Header>
                <Left></Left>
                <Right>
                    <TouchableOpacity onPress={() => props.navigation.goBack()} style={[config.style.iconBtn, { marginRight: -10 }]}>
                        <P>Sign In</P>
                    </TouchableOpacity>
                </Right>
            </Header>
                ...
                <View style={config.style.form}>
                    <TouchableOpacity style={{ flexDirection: "column", ustifyContent: "space-between", paddingVertical: responsiveHeight(1.5) }}>
                        ...
                        <View style={config.style.labelWrapper}>
                            ...
                            <View>
                                <Text style={[config.style.labelText, { color: 'black' }]}>{'Username'}</Text>
                            </View>
                        </View>
                    ...
                    <TouchableOpacity style={{ flexDirection: "column", ustifyContent: "space-between", paddingVertical: responsiveHeight(1.5) }}>
                        ...
                        <View style={config.style.labelWrapper}>
                            ...
                            <View>
                                <Text style={[config.style.labelText, { color: 'black' }]}>{'Email'}</Text>
                            </View>
                        </View>
                        <View style={{ flex: 1, justifyContent: "center", borderWidth: 1, marginTop: 5, borderColor: "#c6c6c6", borderRadius: 6, }}>
                            <TextInput
                    ...
                    <TouchableOpacity style={{ flexDirection: "column", ustifyContent: "space-between", paddingVertical: responsiveHeight(1.5) }}>
                        ...
                        <View style={config.style.labelWrapper}>
                            ...
                            <View>
                                <Text style={[config.style.labelText, { color: 'black' }]}>{'Password'}</Text>
                            </View>
                        </View>
                        <View style={{ flex: 1, justifyContent: "center", borderWidth: 1, marginTop: 5, borderColor: "#c6c6c6", borderRadius: 6, }}>
                            <TextInput
                            ...
                            <TouchableOpacity onPress={() => { setSecureEntry(!secureEntry) }} style={{ position: "absolute", right: 23, bottom: 7 }}>
                                <Icon name={secureEntry ? 'eye-off' : 'eye'} size={18} color={"#bcbcbc"} />
                            </TouchableOpacity>
                        </View>
                    ...
                    <Btn label={'Sign Up'} onPress={() => register()} />
