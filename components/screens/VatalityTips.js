...
import { Image, TouchableOpacity, ScrollView, View, Text, StyleSheet,FlatList } from 'react-native';
...
class VatalityTips extends Component {
  constructor(props) {
    super(props);
    this.state = {
      profilearr: [
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      <View
                        ...
                        <Text style={{fontSize:scale(15), width:scale(290)}}>{item.question}</Text>
                        <EntypoIcon
                          name="chevron-down"
                      ...
                      {this.state.currentIndex == index + 1 ? (
                        <Text style={{fontSize:scale(14),color:'gray'}}>{item.ans}</Text>
                      ) : null}
                    </TouchableOpacity>
                  );
                }}
