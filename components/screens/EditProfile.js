...
//               style={{ marginLeft: 0,  color: '#fff',position:'relative',top:scale(10)  }}
//             />
//           </Left>
//          <H1  style={{ color: '#ffffff', fontSize:scale(18), marginTop:0,position:'relative',top:scale(10) }} >Edit Profile</H1> 
          
//         </Header>
				
// 				<View style={[style.middle]}>
// 					<ScrollView>
// 						<View style={{ justifyContent: "center", alignItems: 'center', height: responsiveHeight(20),  flexDirection: "row", }}>
...
// 									<View style={[style.subcon1]}>
// 										<View style={[style.iconview]}>
// 											<FontAwesomeIcon name="camera" type="FontAwesome" style={[cstyle.H1Text, { color: "#eb6199", }]} />
// 										</View>
// 									</View>
// 									<View style={[style.subcon2]}>
// 										<Text style={[{ color: "#eb6199",marginTop:scale(5) }, cstyle.regularFont, cstyle.H6Text]}>Edit photo</Text>
// 									</View>
// 								</TouchableOpacity>
// 							}
...
// 									</View>
// 									<View style={{ flex: 1, justifyContent: "center", borderWidth: 1, marginTop: 5, borderColor: "#c6c6c6", borderRadius:6,}}>
// 										<TextInput
...
// 												height: 42,
// 												width: '100%',
// 												margin: responsiveWidth(0),paddingHorizontal:scale(17), marginVertical: responsiveHeight(0), borderBottomColor: "#c6c6c6", 
// 											}]}>
// 										</TextInput>
// 									</View>
...
// 								</TouchableOpacity>
// 								<TouchableOpacity style={{ flexDirection: "row", ustifyContent: "space-between", borderBottomWidth: 0, borderBottomColor: "#c6c6c6", paddingVertical: responsiveHeight(1.5) }}>
// 									<View style={{ flex: 0.38, justifyContent: "center", borderRadius:6, }}>
...
// 										Icon={() => {
// 											return <IoniconsIcon name="chevron-down" size={24} color="gray" />;
// 										}}
// 									/>
...
// 											onChangeText={(name) => this.setState({ driverStatus: name })}
...
// 							</View>
// 						</View>
// 						<Btn style={[cstyle.btnlgout]} label={'Save'} type={'light'} />
					   ...
					   <View style={[style.middle]}>
						   <ScrollView>
							   <View style={{ justifyContent: "center", alignItems: 'center', height: responsiveHeight(20),  flexDirection: "row", }}>
								   ...
								   {ProfileImgUrl ?
									   <TouchableOpacity style={[style.profileview]} onPress={() =>showDialog()}>
	   
										   <View style={[style.subcon1]}>
											   <View style={[style.iconview]}>
												   <Image source={{ uri: ProfileImgUrl }} style={{ width: responsiveWidth(20), height: responsiveWidth(20), borderRadius: responsiveWidth(20) }} />
												   {/* <Icon name="camera" type="FontAwesome" style={[cstyle.H1Text, { color: "#ffd428", }]} /> */}
											   </View>
										   </View>
									   ...
									   <TouchableOpacity style={{ flexDirection: "column", ustifyContent: "space-between", paddingVertical: responsiveHeight(1.5) }}>
										   ...
										   <View style={{ flex: 1, justifyContent: "center", borderWidth: 1, marginTop: 5, borderColor: "#c6c6c6", borderRadius:6,}}>
											   <TextInput
												   ...
												   placeholderTextColor={'gray'}
												   keyboardType={'numeric'}
												   onChangeText={(text) => setDriverStatus(text)}
												   value={driverStatus}
												   style={[{
													   height: 42,
													   width: '100%',
