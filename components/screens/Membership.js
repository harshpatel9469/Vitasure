...
const MemberShip = (props) => {
  ...
  const [value, setVlaue] = useState(1000);
        ...
        <View
          ...
          <View style={[styles.shadowProp, styles.medicinecard]}>
            <View style={[styles.cardtopconent]}>
              <Text style={[styles.cardToptextsml]}>
              ...
              <View style={[styles.cardslider]}>
                <Slider
                  ...
                  value={value}
                  onValueChange={(value) => setVlaue(value)}
                />
                <Text style={[styles.cardslidervalue]}>₹ {value} / Month</Text>
              </View>
            </View>
              ...
              renderItem={({item, index}) => {
                return (
                  <TouchableOpacity
                    ...
                    {currentIndex == index + 1 ? <Text>{item.ans}</Text> : null}
                  </TouchableOpacity>
                );
              }}
            />
